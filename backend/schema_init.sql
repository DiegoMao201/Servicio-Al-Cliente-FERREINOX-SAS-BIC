...
CREATE TABLE public.agent_quote (
    id bigserial PRIMARY KEY,
    conversation_id bigint REFERENCES public.agent_conversation(id) ON DELETE SET NULL,
...
CREATE TABLE public.agent_quote_line (
    id bigserial PRIMARY KEY,
...
CREATE TABLE public.agent_order (
    id bigserial PRIMARY KEY,
    conversation_id bigint REFERENCES public.agent_conversation(id) ON DELETE SET NULL,
    contacto_id bigint REFERENCES public.whatsapp_contacto(id) ON DELETE SET NULL,
    cliente_id bigint REFERENCES public.cliente(id) ON DELETE SET NULL,
...
CREATE TABLE public.agent_order_line (
    id bigserial PRIMARY KEY,
...
CREATE INDEX idx_agent_quote_conversation ON public.agent_quote(conversation_id);
CREATE INDEX idx_agent_quote_cliente_estado ON public.agent_quote(cliente_id, estado);
CREATE INDEX idx_agent_quote_line_quote ON public.agent_quote_line(quote_id);
CREATE INDEX idx_agent_order_conversation ON public.agent_order(conversation_id);
CREATE INDEX idx_agent_order_cliente_estado ON public.agent_order(cliente_id, estado);
CREATE INDEX idx_agent_order_quote ON public.agent_order(quote_id);
CREATE INDEX idx_agent_order_line_order ON public.agent_order_line(order_id);
