...
TECHNICAL_PRODUCT_RULES = [
    ...
    {"canonical_label": "ESTUCO ACRILICO EXTERIOR", "preferred_lookup_text": "PQ ESTUCO PROF EXT BL 27060 18.93L 30K", "brand_filters": ["pintuco"], "aliases": ["pintuco estuco acrilico exterior", "estuco acrilico exterior"]},
